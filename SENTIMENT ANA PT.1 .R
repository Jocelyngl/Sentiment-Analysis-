...
infra <- search_tweets("infrastructure deal", n=1000, retryonratelimit = TRUE)
...
ts_plot(infra,"mins",cex=.25,alpha=1) +
  ...
  labs(title = "Frequency of keywords'infrastructure or Build Back Better'used in last 1,000 tweets",
